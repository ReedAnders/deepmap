...
class Particle:
    ...
    def __repr__(self):
        return 'Particle(dimensions=%r, params=%r, fitness=%r, pBest=%r)' % (self.dimensions, self.params, self.fitness, self.pBest)
...
class Swarm:
    ...
    def __repr__(self):
        return 'Swarm(population_size=%r, gBestFitness=%r)' % (self.population_size, self.gBestFitness)
